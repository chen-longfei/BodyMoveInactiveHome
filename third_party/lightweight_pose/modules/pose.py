...
from third_party.lightweight_pose.modules.keypoints import BODY_PARTS_KPT_IDS, BODY_PARTS_PAF_IDS
from third_party.lightweight_pose.modules.one_euro_filter import OneEuroFilter
